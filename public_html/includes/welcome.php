<div calss="bg-black">
    ...
    <!-- Main Writings -->
    <div class="carousel-cover-content" id="brand">
        <h1 class="text-white px-5">TestaLab</h1>
        <h3 class="text-white px-5">Advanced Optical BioImaging <br> 
            at <a class="text-scilife-bold link-scilife" href="#about-scilifelab">Scilifelab</a>
            and <a class="text-kth link-kth" href="#about-kth">KTH</a>
        </h3>                
    </div>

    <!-- Mouse Wheel Icon -->
    <div class="carousel-cover-scroll-icon">
